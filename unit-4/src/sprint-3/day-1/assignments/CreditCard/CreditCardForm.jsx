    ...
    <div style={{ width:"45%"}}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{display:"flex", justifyContent:"space-between", width:"73%"}}>
          ...
          <div>
            <Ptag>CVC</Ptag>
            <InputBox type="number" name="cvc" style={{width:"50px"}} onChange={handleChange}/>
          </div>
        </div>
        ...
        <div style={{display:"flex",margin:"18px", justifyContent:"center"}}><button id={styled.paybtn} type="submit">Pay</button></div>
      </form>
    </div>
  );
}
